...
print("Predicció per data ", dades["prediccion"]
      ["dia"][0]["@attributes"]["fecha"])

print("Predicció: temperatura màxima: ",
      dades["prediccion"]["dia"][0]["temperatura"]["maxima"])

print("Predicció: temperatura mínima: ",
      dades["prediccion"]["dia"][0]["temperatura"]["minima"])
