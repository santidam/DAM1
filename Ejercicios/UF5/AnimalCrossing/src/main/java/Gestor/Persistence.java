...
public class Persistence {
    ...
    public void sobreEscribir(ArrayList<LoQueSea> lista) {
            ...
            if (!f.exists()) {
                ...
                try {
                    ...
                    while ((linea = br.readLine()) != null) {
                        ...
                        LoQueSea p = new LoQueSea(parameters[0],parameters[1], Double.parseDouble(parameters[2]));
                        listaObjetos.add(p);
